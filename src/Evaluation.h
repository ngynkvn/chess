...
int get_piece_value(ePieceCode p, int x);
...
// Rook table
const int black_rook_table[64] = {  0,  0,  0,  5,  5,  0,  0,  0,
                                     -5,  0,  0,  0,  0,  0,  0, -5,
                                     -5,  0,  0,  0,  0,  0,  0, -5,
                                     -5,  0,  0,  0,  0,  0,  0, -5,
                                     -5,  0,  0,  0,  0,  0,  0, -5,
...
// King mid-game table
const int black_king_mid_table[64] = { -30, -40, -40, -50, -50, -40, -40, -30,
...
const int white_king_mid_table[64] = {  20,  30,  10,  0 ,  0 ,  10,  30,  20 ,
                                          20,  20,  0 ,  0 ,  0 ,  0 ,  20,  20 ,
                                         -10, -20, -20, -20, -20, -20, -20, -10 ,
                                         -20, -30, -30, -40, -40, -30, -30, -20 ,
                                         -30, -40, -40, -50, -50, -40, -40, -30 ,
...
// King end-game table
const int white_king_end_table[64] = { -50, -30, -30, -30, -30, -30, -30, -50,
                                         -30, -30,   0,   0,   0,   0, -30, -30,
...
const int black_king_end_table[64] = { -50, -40, -30, -20, -20, -30, -40, -50,
                                         -30, -20, -10,   0,   0, -10, -20, -30,
                                         -30, -10,  20,  30,  30,  20, -10, -30,
                                         -30, -10,  30,  40,  40,  30, -10, -30,
                                         -30, -10,  30,  40,  40,  30, -10, -30,
