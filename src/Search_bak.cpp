                ...
                if(nextRow>=0 && nextRow <= 7){
                    ...
                    if(coll >=0 && coll <=7){
                        ...
                        if(!ifMoveInCheck(p)){
                            if(l.getColor()==black)
                            {
                                 // this is x,y,x,y from perspective of white
                                v.push_back(Move(col,row,coll,nextRow)); //THE CHOOL INE HEREEE
                            }
                        }
                    }
                    ...
                    if(cola>=0 && cola <=7){
                        ...
                        if(!ifMoveInCheck(p)){
                            if(a.getPieceCode()== -1) // in piece.h empty square = -1
                            {
                                ...
                                v.push_back(Move(col,row,cola,nextRow));
                                if(a2.getPieceCode()==-1 && !hasMoved(p)){
                                    v.push_back(Move(col,row,col,nextRow2));
                                }
                            }
                        }
                    }
                    if(colr>=0 && colr <=7){
                        ...
                        if(!ifMoveInCheck(p)){
                            ...
                            {
                                v.push_back(Move(col,row,colr,nextRow));
                            }
                        }
                    }
                }
